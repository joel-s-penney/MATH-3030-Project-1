...
In this project, I aim to study root-finding algorithms for polynomials of one variable. In particular, I want to examine the bisection method, Newton's method, and more advanced methods used frequently in numerical analysis today. This project will start by reviewing the theoretical foundations of root-finding. Then, I will implement the algorithms and determine strengths and weaknesses of each method.
...
After reviewing the literature and narrowing down exactly which methods to study, I will write code in \texttt{Python} that uses these methods to find the roots of a given polynomial. To compare each method, I will likely have to track the number of iterations, error, or other measures of success and efficiency. I plan to use Jupyter notebooks and perhaps the \texttt{SciPy} package to some degree.

\subsection*{Link to Version Control Repository}

\texttt{https://github.com/joel-s-penney/MATH-3030-Project-1.git}

\subsection*{Preliminary References}

\begin{itemize}
    \item Bahman Kalantari. Polynomial root-finding and polynomiography. World Scientific, 2008.
    \item Markus Lang and B-C Frenzel. Polynomial root finding. IEEE Signal Processing Letters, 1(10):141–143, 1994.
\end{itemize}
